  ...
  return (
    <div className="w-full flex flex-col justify-center items-center lg:py-10 mx-auto p-3">
      {id == "1" ? (
        <>
          <div className="flex justify-between items-center gap-4 w-full max lg:max-w-7xl mx-auto mb-4 lg:mb-[129px]">
            <h2 className="text-[#161515] font-montalternates text-[32px] lg:text-[48px] font-semibold leading-[164%]">
              {foundObject.name}
            </h2>
            ...
            <div className="mt-[80px]">
              ...
              <ol className="list-decimal pl-4" type="1">
                <li className="font-montalternates text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
                  Streamline Verification: Simplify the verification process for
                  citizens, reducing the number of steps and documentation
                  required.
                </li>
                <li className="font-montalternates text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
        ...
        <>
          <div className="flex justify-between items-center gap-4 w-full max lg:max-w-7xl mx-auto mb-4 lg:mb-[129px]">
            <h2 className="text-[#161515] font-montalternates text-[48px] font-semibold leading-[164%]">
              {foundObject.name}
            </h2>
            <button className="border-2 w-[#186px] h-[53px] p-[10px] border-[#161515] shadow-xl rounded-full flex justify-center items-center">
              <p className="underline">View Project</p>
            ...
            <div className="mt-[80px]">
              ...
              <ul className="list-disc pl-4">
                ...
                <li className="font-montalternates text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
                  ...
                  over their work life, leading to improved job satisfaction and
                  engagement.
                </li>
                <li className="font-montalternates text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
                  <span className="font-semibold">
                  ...
                  necessary to handle payroll significantly. Employers reported
                  increased efficiency and a reduction in payroll-related
                  errors.
                </li>
                <li className="font-montalternates text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
      ...
      <div className="w-full flex flex-col justify-center items-center lg:py-10 mx-auto p-3">
        ...
        <h2 className="text-justify font-montalternates font-bold leading-[149.5%] text-[34px] lg:text-[48px] text-[#49BDAC]">
