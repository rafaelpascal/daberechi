...
const Project = () => {
  ...
  return (
    <div className="bg-[#FAFAFA] py-8 lg:py-[92.5px]">
      <Link
        to={"/work"}
        className="flex justify-start items-start max lg:max-w-7xl mx-auto px-3"
      >
        <div className="flex justify-center items-center gap-2">
          <img src={arrowLeft} alt="arrowLeft" />
          <p className="text-justify font-montalternates font-semibold leading-[164%] text-[12px] lg:text-[20px] text-[#1A73E8]">
            Go Back
          </p>
        </div>
      </Link>
      <div className="w-full flex flex-col justify-center items-center lg:py-10 mx-auto">
        {id == "1" ? (
          <>
            <div className="flex flex-col sm:flex-row justify-start lg:justify-between items-start lg:items-center gap-4 w-[342px] lg:w-[1182px] max lg:max-w-7xl mx-auto mb-4 lg:mb-[129px]">
              <h2 className="text-[#161515] font-montalternates text-[22px] lg:text-[48px] font-bold leading-[164%]">
                {foundObject.name}
              </h2>
              <button className="border-2 w-[186px] h-[53px] p-[10px] border-[#161515] shadow-xl rounded-full flex justify-center items-center">
                <p className="underline font-montalternates">View Project</p>
                <img src={arrowUp} alt="arrowUp" />
              </button>
            </div>
            <div className="flex justify-between items-center gap-4 w-[342px] lg:w-[1182px] max lg:max-w-7xl mx-auto mb-[29px]">
              <div>
                <p className="text-[10px] lg:text-[14px] font-montalternates font-normal text-[#161515]">
                  Client
                </p>
                <p className="text-[10px] lg:text-[14px] font-montalternates font-normal text-[#161515]">
                  {foundObject.client}
            ...
            <div className="flex flex-col justify-between items-center gap-4 w-full max lg:max-w-7xl mx-auto mb-[129px]">
              <img
                src={foundObject.img}
                alt=""
                className="w-[342px] lg:w-[1182px]"
              />
              <div className="mt-4 lg:mt-[98px] w-[342px] lg:w-[1182px]">
                <h2 className="font-montalternates text-[26px] lg:text-[36px] text-[#161515] text-left lg:text-justify leading-[164%] font-bold">
                  Introduction
                </h2>
                <p className="font-montalternates text-[12px] lg:text-[18px] text-[#161515] text-justify leading-[164%] font-normal">
                  {foundObject.introduction}
                </p>
              </div>
              <div className="mt-[48px] w-[342px] lg:w-[1182px]">
                <h2 className="font-montalternates text-[26px] lg:text-[36px] text-[#161515] text-left lg:text-justify leading-[164%] font-bold">
              ...
              <div className="mt-[48px] w-[342px] lg:w-[1182px]">
                <p className="font-montalternates text-[12px] lg:text-[18px] text-[#1A73E8] italic text-justify leading-[164%] font-normal">
              ...
              <div className="mt-[80px] w-[342px] lg:w-[1182px]">
                <h2 className="font-montalternates text-[26px] lg:text-[36px] text-[#161515] text-left lg:text-justify leading-[164%] font-bold">
                  Defining Objectives:
                </h2>
                <p className="font-montalternates text-[12px] lg:text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
                ...
                <ol className="list-decimal pl-4" type="1">
                  <li className="font-montalternates text-[12px] lg:text-[18px] mb-2 text-[#161515] text-justify leading-[164%] font-normal">
        ...
        <div className="w-full flex flex-col justify-center items-center lg:py-10 mx-auto p-3">
          <h2 className="text-justify font-montalternates font-bold leading-[164%] text-[16px] lg:text-[32px] text-[#161515]">
            Shoot me mail
          </h2>
          <h2 className="text-justify font-montalternates font-bold leading-[149.5%] text-[20px] lg:text-[48px] text-[#49BDAC]">
