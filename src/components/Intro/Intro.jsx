  ...
  return (
    ...
    >
      <div className="w-full flex flex-col sm:flex-row justify-between items-center lg:py-10 lg:max-w-7xl mx-auto p-3">
        ...
        <div>
          <img src={dabIntro} alt="Dabs" />
          <p className="text-[21px] text-[#4F4F4F] font-montalternates font-normal leading-none w-full lg:w-[497px] my-[24px]">
          ...
          <ul className="flex justify-start gap-8 items-center w-full lg:w-[497px]">
